...
INSERT INTO questions (subject_id, question_text, question_image, model_answer, max_marks) VALUES
    (1, 'Describe the chest X-ray findings', 'https://radiologybusiness.com/sites/default/files/2022-09/Breast%20MRI%20invasive%20ductal%20carcinoma_Computer-aided_volumetry_images_pre%20and%20post%20chemo_partial_response_RSNA.jpg', 
     ...
     10),
    (1, 'Analyze the CT scan', 'https://images.fineartamerica.com/images-medium-large/2-breast-implants-x-ray-.jpg', 
     ...
     10),
    (2, 'Describe the echocardiogram', 'https://images.unsplash.com/photo-1628595351029-c2bf17511435?w=800&h=600&fit=crop', 
     ...
     10),
    (3, 'Identify findings on the brain MRI', 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&h=600&fit=crop', 
     ...
     10),
    (4, 'Describe the knee MRI', 'https://images.unsplash.com/photo-1559825481-12a05cc00344?w=800&h=600&fit=crop', 
